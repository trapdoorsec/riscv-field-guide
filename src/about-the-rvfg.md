...
At times, you will want to refer to the resources in the [References](sources.md) section, particularly if you need reference a source of truth.
...
- [Psuedoinstructions](pseudointructions/index.md)
